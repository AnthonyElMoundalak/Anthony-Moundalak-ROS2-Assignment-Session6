...
class Metaclass_CheckStock(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from my_interface.srv import _check_stock
...
class CheckStock(metaclass=Metaclass_CheckStock):
    from my_interface.srv._check_stock import CheckStock_Request as Request
    from my_interface.srv._check_stock import CheckStock_Response as Response
